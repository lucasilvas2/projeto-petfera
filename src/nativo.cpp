...
Tratador* Nativo::getTratador() const{
	return this->tratador;
}

Veterinario* Nativo::getVeterinario() const{
...
void Nativo::setTratador(Tratador &tratador){
	this->tratador=&tratador;
}

void Nativo::setVeterinario(Veterinario &veterinario){
